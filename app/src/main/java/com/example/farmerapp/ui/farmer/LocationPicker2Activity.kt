...
import com.schibstedspain.leku.LocationSearchAdapter
...
class LocationPicker2Activity : AppCompatActivity(),
    OnMapReadyCallback,
    ...
    class Builder {
        ...
        fun build(context: Context): Intent {
            val intent = Intent(context, LocationPicker2Activity::class.java)
